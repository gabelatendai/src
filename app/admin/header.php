...
<!-- ########## START: LEFT PANEL ########## -->
<div class="br-logo"><a href=""><span>[</span>YES <i>games</i><span>]</span></a></div>
<div class="br-sideleft sideleft-scrollbar">
    ...
    <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
            <a href="add_sportcode.php" class="br-menu-link">
                <i class="menu-item-icon ion-android-add-circle tx-24"></i>
                <span class="menu-item-label">Add SportCode & Zones</span>
            </a><!-- br-menu-link -->
        </li><!-- br-menu-item -->
        <li class="br-menu-item">
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="sportcodes.php" class="sub-link">Sportcodes</a></li>
                <li class="sub-item"><a href="zones.php" class="sub-link">Zones</a></li>
                <li class="sub-item"><a href="statistics.php" class="sub-link">Master List</a></li>
            </ul>
        </li>
        <li class="br-menu-item">
            <a href="#" class="br-menu-link with-sub">
            ...
            <ul class="br-menu-sub">
                <li class="sub-item"><a href="addUser.php" class="sub-link">Add Users</a></li>
	            <li class="sub-item"><a href="manageUsers.php" class="sub-link">Users</a></li>
        ...
        <nav class="nav">
            ...
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    ...
                    <img src="<?php echo $init['image']; ?>" class="wd-32 rounded-circle" alt="">
                    <span class="square-10 bg-success"></span>
                </a>
                <div class="dropdown-menu dropdown-menu-header wd-250">
                    <div class="tx-center">
                        <a href=""><img src="<?php echo $init['image']; ?>" class="wd-80 rounded-circle" alt=""></a>
