...
?>
    <!-- ########## START: MAIN PANEL ########## -->
<h1 align="center">Manage Zones</h1>
        ...
        <div class="br-section-wrapper">
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap"  width="auto">
              <thead>
                <tr>
                  <th class="wd-15p">Zone Title</th>
                  <th class="wd-15p">Zone Description</th>
			              ...
			              <div class="modal-dialog">
				              <div class="modal-content">
					              <div class="modal-header">
						              <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-user"></i> Zone</h4>
					              </div>
					              <div class="modal-body">
						              ...
						              <div class="modal-footer">
							              ...
							              <a href="deletezones.php<?php echo '?id='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
						              </div>
					              </div>
				              </div>
			              </div>
