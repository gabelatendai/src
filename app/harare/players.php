    ...
    <!-- ########## START: MAIN PANEL ########## -->
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="br-section-label">Registered  <?php echo $name ;?>  Participants</h6>
          ...
          <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap"  width="auto">
              ...
              <tbody>
              <?php
              $players = R::findAll('players','sportcode=? AND province=?',[$id,$province]);
              ...
              foreach ($players as $player) {
	              ...
	              <tr>
		              ...
		              <td>
			              <a class="btn btn-success btn-block mg-b-10" href="edit_participant.php<?php echo  '?id='.$playerid;  ?>" ><i class="fa fa-edit mg-r-10"></i> Edit</a>
