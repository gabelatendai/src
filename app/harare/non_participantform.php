    ...
    <!-- ########## START: MAIN PANEL ########## -->
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
	        ...
	        <div>
		        <h4>Non Participant Accreditation Form</h4>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="idno" placeholder="Enter Your National ID Number" required>
                </div>
              </div><!-- col-4 --
              <div class="col-lg-4">
                <div class="form-group">
...
<label></label>
	            ...
	            <div class="col-lg-4">
		            <div class="form-group mg-b-10-force">
			            ...
			            <select class="form-control select2" data-placeholder="" name="sportcode" >
				            <option value="">Select SportCode</option>
	            ...
	            <div class="col-lg-4">
		            <div class="form-group mg-b-10-force">
			            ...
			            <select class="form-control select2" data-placeholder="Choose country" name="category" required >
				            <option value="">Select Category</option>

				            <?php  $subs= R::findAll('categories');
	            ...
	            <div class="col-lg-4">
		            <div class="form-group mg-b-10-force">
			            <label class="form-control-label">Zone Access<span class="tx-danger">*</span></label>
			            <select class="form-control select2" data-placeholder="Choose country" name="zone" required >
				            <option value="">Select Zone</option>

				            <?php  $subs= R::findAll('zones');
